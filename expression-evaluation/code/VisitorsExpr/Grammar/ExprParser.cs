...
public partial class ExprParser : Parser {
	...
	public partial class TermFactContext : TermContext {
		...
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			IExprVisitor<TResult> typedVisitor = visitor as IExprVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitTermFact(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public partial class FactDigitContext : FactContext {
		...
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			IExprVisitor<TResult> typedVisitor = visitor as IExprVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitFactDigit(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	private static int[] _serializedATN = {
		...
		4,0,0,27,0,11,1,0,0,0,2,18,1,0,0,0,4,25,1,0,0,0,6,7,3,2,1,0,7,8,5,5,0,
		0,8,9,3,0,0,0,9,12,1,0,0,0,10,12,3,2,1,0,11,6,1,0,0,0,11,10,1,0,0,0,12,
		1,1,0,0,0,13,14,3,4,2,0,14,15,5,1,0,0,15,16,3,2,1,0,16,19,1,0,0,0,17,19,
		3,4,2,0,18,13,1,0,0,0,18,17,1,0,0,0,19,3,1,0,0,0,20,21,5,2,0,0,21,22,3,
		0,0,0,22,23,5,3,0,0,23,26,1,0,0,0,24,26,5,4,0,0,25,20,1,0,0,0,25,24,1,
